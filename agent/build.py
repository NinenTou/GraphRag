...
from workflow import table_processing_node, sql_get_node, err_reporter_node, correct_reporter_node
...
def _build_base_graph():
    ...
    builder.add_conditional_edges(
        "table_processing",
        lambda state: "sql_get" if state["sql_get_iterations"] > 0 else "reporter"
    )
